      ...
      <div class="wedding__party__warpper owl-carousel owl-theme">
         <div class="party__items">
            <div class="party__thumb">
               <img src="assets/img/party/wedding1.jpg" alt="about-image" style="height: 50%;">
            </div>
         ...
         <div class="party__items">
            <div class="party__thumb">
               <img src="assets/img/party/wedding2.jpg" alt="about-image" style="height: 50%;">
            </div>
            <div class="party__content">
               <h4>
                  <a href="#0">
         ...
         <div class="party__items">
            <div class="party__thumb">
               <img src="assets/img/party/wedding3.jpg" alt="about-image" style="height: 50%;">
            </div>
            <div class="party__content">
               <h4>
                  <a href="#0">
